...
!(function (t, e) {
   ...
   var v = {},
      ...
      tt = function (t, e, n) {
         if (
            ...
            if ('string' != typeof e.customClass[n] && !e.customClass[n].forEach)
               return void k(
                  'Invalid type of customClass.'.concat(n, '! Expected string or iterable object, got "').concat(m(e.customClass[n]), '"'),
               );
      ...
      et = function (t, e) {
         ...
         switch (e) {
            ...
            case 'radio':
               return (
                  t.querySelector('.'.concat(y.popup, ' > .').concat(y.radio, ' input:checked')) ||
                  t.querySelector('.'.concat(y.popup, ' > .').concat(y.radio, ' input:first-child'))
               );
            case 'range':
      ...
      wt = function (t) {
         var e,
            n =
               !!(e = O()) &&
               (e.remove(), rt([document.documentElement, document.body], [y['no-backdrop'], y['toast-shown'], y['has-column']]), !0);
            ...
            (function (t, e, n) {
               ...
               Bt(o, 'confirm', n),
                  ...
                  (function (t, e, n, o) {
                     ...
                     it([t, e, n], y.styled),
                        o.confirmButtonColor && ((t.style.backgroundColor = o.confirmButtonColor), it(t, y['default-outline']));
   ...
   var Vt = function (t, e) {
      ...
      zt = function (t, e) {
         ...
         (t.className = ''.concat(y.popup, ' ').concat(pt(t) ? n.popup : '')),
            e.toast ? (it([document.documentElement, document.body], y['toast-shown']), it(t, y.toast)) : it(t, y.modal),
            tt(t, e, 'popup'),
               ...
               if (o) {
                  ...
                  if (e.icon || e.iconHtml) {
                     if (e.icon && -1 === Object.keys(w).indexOf(e.icon))
                        return (
                           E('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"')), void st(o)
                        );
      ...
      se = function (t) {
         ...
         return (
            ...
            !le(t) &&
            !de(t) &&
            (e === n || (!mt(n) && e instanceof HTMLElement && 'INPUT' !== e.tagName && 'TEXTAREA' !== e.tagName && (!mt(o) || !o.contains(e))))
         );
      },
      le = function (t) {
   ...
   function me(t, e, n, o) {
      X()
         ...
         : (g(n).then(function () {
           ...
           Jt(v)),
         ce ? (e.setAttribute('style', 'display:none !important'), e.removeAttribute('class'), (e.innerHTML = '')) : e.remove(),
         J() &&
   ...
   function Ue(t, e) {
      var n = I();
      if (n && t)
         if ('radio' === t.type) for (var o = n.querySelectorAll('[name="'.concat(y.radio, '"]')), i = 0; i < o.length; i++) o[i].disabled = e;
         else t.disabled = e;
   }
   function ze() {
   ...
   function sn() {
      ...
      e
         ? (t.popup && v.swalCloseEventFinishedCallback && (v.swalCloseEventFinishedCallback(), delete v.swalCloseEventFinishedCallback),
               ...
               'object' !== m(t[0]) || wn(t[0])
                  ? ['title', 'html', 'icon'].forEach(function (n, o) {
                       ...
                       'string' == typeof i || wn(i)
                          ? (e[n] = i)
                          : void 0 !== i && E('Unexpected type of '.concat(n, '! Expected "string" or "Element", got ').concat(m(i)));
                    })
                  : Object.assign(e, t[0]),
               e
            );
